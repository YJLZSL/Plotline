...
### 当前版本状态
- **最新版本**：v4.0.0（相对时间轴纯故事顺序标尺 + 地图图层 + VN 立绘拖拽 + 世界观冲突检测 + 日文翻译，已提交发布）<https://github.com/YJLZSL/Plotline/releases/tag/v4.0.0>
- **历史版本**：v3.6.0、v3.5.0、v3.3.0；v3.4.0 重构已并入 v3.5.0
...
### 下一迭代方向
- **长期目标**：见 `docs/长期迭代计划.md`（Phase 1「v3.3」→ Phase 1.5「v3.4 重构」→ Phase 2「v3.5 写作闭环」→ Phase 2.5「v3.6 时间轴重做」→ Phase 3「v4.0 深度创作首批」→ Phase 4「v4.1+ 打磨发布」）。
- **当前重点（v4.1+）**：地图打印/PDF 导出与角色足迹连线、VN Ren'Py 导出增强、完整 AI Agent 工作流（自动整理大纲、输出版本回溯）、统一空状态插画、性能与无障碍深度优化。
